...
(setq org-todo-keywords
      '((sequence "TODO(t)" "NOTE(n)" "|" "CANCELLED(c@)" "DONE(d!)")))
...
(setq org-capture-templates
      '(
        ...
        ("t" "Todo" entry (file "~/pu/org/agenda.org")
         (file "~/.emacs.d/etc/templates/agenda_template.txt"))

        ("i" "Inbox" entry (file "~/dc/inbox.org")
...
** 󰙅 Vundo.
:LOGBOOK:
- Note taken on [2024-05-09 Thu 15:15] \\
...
<<<<<<< HEAD
*  Passive pkgs
- Many packages that work in the background, you dont have to think about them
=======
*  Passive Pkgs
>>>>>>> tmp
